...
LEMONADE_EMBEDDING_MODEL=$(Get-EnvOrNew "LEMONADE_EMBEDDING_MODEL" "")
LEMONADE_RERANK_MODEL=$(Get-EnvOrNew "LEMONADE_RERANK_MODEL" "")
LEMONADE_STT_MODEL=$(Get-EnvOrNew "LEMONADE_STT_MODEL" "")
LEMONADE_TTS_MODEL=$(Get-EnvOrNew "LEMONADE_TTS_MODEL" "")
DASHBOARD_LEMONADE_PROBE_TTL=$(Get-EnvOrNew "DASHBOARD_LEMONADE_PROBE_TTL" "120")
DASHBOARD_LEMONADE_ACTIVE_PROBE_TIMEOUT=$(Get-EnvOrNew "DASHBOARD_LEMONADE_ACTIVE_PROBE_TIMEOUT" "120")
