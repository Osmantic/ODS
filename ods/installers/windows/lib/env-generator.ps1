...
function New-ODSEnv {
    ...
    $langfuseS3AccessKey    = Get-EnvOrNew "LANGFUSE_S3_ACCESS_KEY"  (New-SecureHex -Bytes 16)
    $langfuseS3SecretKey    = Get-EnvOrNew "LANGFUSE_S3_SECRET_KEY"  (New-SecureHex -Bytes 32)
...
LANGFUSE_S3_ACCESS_KEY=$langfuseS3AccessKey
LANGFUSE_S3_SECRET_KEY=$langfuseS3SecretKey
