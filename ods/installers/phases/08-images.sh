...
if [[ "$ENABLE_HERMES" == "true" ]]; then
    ...
    PULL_LIST+=("${HERMES_AGENT_IMAGE:-docker.io/nousresearch/hermes-agent@sha256:63bfb6d732f49a55d453e801057273785cc61e0f6ee43db3fa2f2a79846301b7}|HERMES — default agent (Nous Research)")
