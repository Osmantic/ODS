...
LLM_PORT="${OLLAMA_PORT:-${LLM_PORT:-${SERVICE_PORTS[llama-server]:-11434}}}"
...
EMBEDDING_PORT="${EMBEDDINGS_PORT:-${EMBEDDING_PORT:-${SERVICE_PORTS[embeddings]:-8090}}}"
LIVEKIT_HOST="${LIVEKIT_HOST:-localhost}"
LIVEKIT_PORT="${LIVEKIT_PORT:-7880}"
PRIVACY_SHIELD_PORT="${SHIELD_PORT:-${PRIVACY_SHIELD_PORT:-${SERVICE_PORTS[privacy-shield]:-8085}}}"
