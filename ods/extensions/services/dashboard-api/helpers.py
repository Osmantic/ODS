...
def list_chunk_overlapping_step_safe(items: list | None, size: int = 3, step: int = 2) -> list[list]:
    """Safely partition list into overlapping window chunks given window size and step.
