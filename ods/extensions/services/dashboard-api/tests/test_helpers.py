...
class TestNumericSafeSigmoidSafe:
    def test_valid_sigmoid(self):
        from helpers import numeric_safe_sigmoid_safe
        assert numeric_safe_sigmoid_safe(0) == 0.5
        assert numeric_safe_sigmoid_safe(100) == 1.0

    def test_invalid_inputs(self):
        from helpers import numeric_safe_sigmoid_safe
        assert numeric_safe_sigmoid_safe(None) == 0.5
        assert numeric_safe_sigmoid_safe("0") == 0.5
