...
class TestNumericMovingAverageSafe:
    def test_valid_moving_average(self):
        from helpers import numeric_moving_average_safe
        assert numeric_moving_average_safe([10, 20, 30, 40], 2) == [10.0, 15.0, 25.0, 35.0]

    def test_invalid_inputs(self):
        from helpers import numeric_moving_average_safe
        assert numeric_moving_average_safe(None) == []
        assert numeric_moving_average_safe(["a", "b"]) == []
