...
class TestStringSafeBase64Encode:
    def test_valid(self):
        from helpers import string_safe_base64_encode
        assert string_safe_base64_encode("hello") == "aGVsbG8="

    def test_invalid(self):
        from helpers import string_safe_base64_encode
        assert string_safe_base64_encode(None) == ""
