...
class TestStringTruncateRightSuffixSafe:
    def test_valid_truncation(self):
        from helpers import string_truncate_right_suffix_safe
        assert string_truncate_right_suffix_safe("Hello World Long Text", 12) == "Hello Wor..."

    def test_invalid_inputs(self):
        from helpers import string_truncate_right_suffix_safe
        assert string_truncate_right_suffix_safe(None) == ""
        assert string_truncate_right_suffix_safe("short", -5) == "short"
