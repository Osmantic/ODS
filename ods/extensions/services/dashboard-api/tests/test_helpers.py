...
class TestStringSafeTitleCase:
    def test_valid(self):
        from helpers import string_safe_title_case
        assert string_safe_title_case("hello world") == "Hello World"

    def test_invalid(self):
        from helpers import string_safe_title_case
        assert string_safe_title_case(None) == ""
