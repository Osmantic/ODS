...
class TestListSafeRotate:
    def test_valid(self):
        from helpers import list_safe_rotate
        assert list_safe_rotate([1, 2, 3, 4], 1) == [4, 1, 2, 3]
        assert list_safe_rotate([1, 2, 3, 4], -1) == [2, 3, 4, 1]

    def test_invalid(self):
        from helpers import list_safe_rotate
        assert list_safe_rotate(None) == []
