...
class TestNumericSafeLog2ScaledSafe:
    def test_valid_scaled_log2(self):
        from helpers import numeric_safe_log2_scaled_safe
        assert numeric_safe_log2_scaled_safe(7) == 3.0
        assert numeric_safe_log2_scaled_safe(0) == 0.0

    def test_invalid_inputs(self):
        from helpers import numeric_safe_log2_scaled_safe
        assert numeric_safe_log2_scaled_safe(-1) == 0.0
        assert numeric_safe_log2_scaled_safe(None) == 0.0
