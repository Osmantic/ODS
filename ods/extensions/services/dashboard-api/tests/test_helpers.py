...
class TestStringReplaceAllOccurrencesSafe:
    def test_valid_replacement(self):
        from helpers import string_replace_all_occurrences_safe
        assert string_replace_all_occurrences_safe("foo bar foo", "foo", "baz") == "baz bar baz"

    def test_invalid_inputs(self):
        from helpers import string_replace_all_occurrences_safe
        assert string_replace_all_occurrences_safe(None, "a", "b") == ""
        assert string_replace_all_occurrences_safe("text", None, "b") == "text"
