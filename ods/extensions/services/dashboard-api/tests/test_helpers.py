...
class TestNumericSafeCeilingSafe:
    def test_valid_ceiling(self):
        from helpers import numeric_safe_ceiling_safe
        assert numeric_safe_ceiling_safe(3.14) == 4
        assert numeric_safe_ceiling_safe(-2.5) == -2

    def test_invalid_inputs(self):
        from helpers import numeric_safe_ceiling_safe
        assert numeric_safe_ceiling_safe(None) == 0
        assert numeric_safe_ceiling_safe("3.14") == 0
