...
class TestStringIsValidUrlSafe:
    def test_valid_url(self):
        from helpers import string_is_valid_url_safe
        assert string_is_valid_url_safe("https://example.com/api") is True
        assert string_is_valid_url_safe("not_a_url") is False

    def test_invalid_inputs(self):
        from helpers import string_is_valid_url_safe
        assert string_is_valid_url_safe(None) is False
        assert string_is_valid_url_safe(999) is False
