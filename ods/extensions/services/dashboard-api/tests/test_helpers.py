...
class TestNumericSafeMeanCalc:
    def test_valid(self):
        from helpers import numeric_safe_mean_calc
        assert numeric_safe_mean_calc([2, 4, 6]) == 4.0

    def test_invalid(self):
        from helpers import numeric_safe_mean_calc
        assert numeric_safe_mean_calc([None, "bad"]) == 0.0
