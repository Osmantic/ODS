...
class TestListSafeIntersection:
    def test_valid(self):
        from helpers import list_safe_intersection
        assert list_safe_intersection([1, 2, 3], [2, 3, 4]) == [2, 3]

    def test_invalid(self):
        from helpers import list_safe_intersection
        assert list_safe_intersection(None, [1]) == []
