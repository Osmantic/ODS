...
class TestNumericSafePercentageCalc:
    def test_valid(self):
        from helpers import numeric_safe_percentage_calc
        assert numeric_safe_percentage_calc(50, 200) == 25.0

    def test_invalid(self):
        from helpers import numeric_safe_percentage_calc
        assert numeric_safe_percentage_calc(10, 0) == 0.0
