...
class TestListExtractByIndicesSafe:
    def test_valid(self):
        from helpers import list_extract_by_indices_safe
        assert list_extract_by_indices_safe(['a', 'b', 'c'], [0, 2, 5]) == ['a', 'c']

    def test_invalid(self):
        from helpers import list_extract_by_indices_safe
        assert list_extract_by_indices_safe(None, [0]) == []
