...
class TestNumericSafeRemainderSafe:
    def test_valid_remainder(self):
        from helpers import numeric_safe_remainder_safe
        assert numeric_safe_remainder_safe(10, 3) == 1.0

    def test_invalid_inputs(self):
        from helpers import numeric_safe_remainder_safe
        assert numeric_safe_remainder_safe(10, 0) == 0.0
        assert numeric_safe_remainder_safe(None, 3) == 0.0
