...
function publish(g,content,{authored=true}={}) {
  ...
  assert.match(verification.text,authored?/Created by Portal\./:/Published from your workspace\./);
  if(!authored)assert.doesNotMatch(verification.text,/Created by Portal\./);
