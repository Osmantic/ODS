...
@pytest.mark.parametrize("module_name", [repair_module.COMPLETION_MODULE, repair_module.IMAGE_MODULE,
                                         ...
                                         repair_module.TOOL_RESULT_PROJECTION_MODULE, repair_module.PRECHECK_ROUTE_MODULE])
...
@pytest.mark.parametrize('environment,manifest_name,module_name', [
    ...
    ('OPENCLAW_ATTEMPT_CONTEXT_MODULE', 'openclaw-precheck-route.json', repair_module.PRECHECK_ROUTE_MODULE),
