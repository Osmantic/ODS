...
// pixel_ods_research (Perplexica) sources never count, nor do search_read leads
// or the [L#] links it lists. This is an attribution boundary, not
// verification of the claims on a page.
