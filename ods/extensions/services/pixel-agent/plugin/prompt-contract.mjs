...
export function promptContractForAgent(
  ...
  return {
    appendSystemContext:
      `${conversationContract}${githubSource}${githubExtension}${extensionInventory}${extensionCatalog}${extensionLifecycle}${operationsContinuation}${operationsInventory}${operationsRequest}${exactDownload}${workspacePreview}${project}${recovery}${verification}${privateUrl}`,
  };
}
