...
export const ODS_COMPACT_CONVERSATION_CONTRACT = [
  ...
  "Call visible tools directly using their exposed schemas. Tool Search finds tools, not files; use it by name only when a needed tool is deferred or not visible. List with exec ls, find or rg --files; read needs a file. Use workspace-relative paths without a workspace/ prefix. An empty search or failed read does not prove absence.",
