...
PRECHECK_ROUTE_MODULE = "attempt.tool-run-context-yigSIkBW.js"
VERSION = "2026.6.33"
...
def repair(runtime_root, state_dir, *, restore=False, manifest_path=MANIFEST,
    ...
    if module_name not in {MODULE, COMPLETION_MODULE, IMAGE_MODULE, COMPACTION_MODULE, COMPACTION_IDLE_MODULE,
                           ...
                           TOOL_RESULT_PROJECTION_MODULE, PRECHECK_ROUTE_MODULE}:
...
def main():
    ...
    selection.add_argument("--precheck-route", action="store_true")
    ...
    elif args.precheck_route:
        options = {"module_name": PRECHECK_ROUTE_MODULE,
                   "manifest_path": MANIFEST.with_name("openclaw-precheck-route.json")}
