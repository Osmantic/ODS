...
test('uses compact source tabs and collapsible filters in the portal panel', () => {
  ...
  expect(installedTab).toHaveAttribute('aria-controls', 'model-panel-installed')
  expect(screen.getByRole('tabpanel')).toHaveAttribute('aria-labelledby', 'model-tab-installed')
})
