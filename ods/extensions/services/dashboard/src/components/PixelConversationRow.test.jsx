...
it('opens only supported actions on right click, supports keyboard navigation and restores focus',()=>{
  ...
  expect(within(menu).getAllByRole('menuitem').map(item=>item.textContent)).toEqual(['Rename','Pin','Archive','Export conversation','Download printable transcript','Delete chat'])
