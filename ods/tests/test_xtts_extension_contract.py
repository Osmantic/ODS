...
SERVICE_DIR = ROOT / "extensions/library/services/xtts"

def test_xtts_manifest_structure():
    manifest_path = SERVICE_DIR / "manifest.yaml"
    assert manifest_path.exists(), f"Manifest missing for xtts"
