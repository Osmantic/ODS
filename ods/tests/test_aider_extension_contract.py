...
SERVICE_DIR = ROOT / "extensions/library/services/aider"

def test_aider_manifest_structure():
    manifest_path = SERVICE_DIR / "manifest.yaml"
    assert manifest_path.exists(), f"Manifest missing for aider"
