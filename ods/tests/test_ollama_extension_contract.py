...
SERVICE_DIR = ROOT / "extensions/library/services/ollama"

def test_ollama_manifest_structure():
    manifest_path = SERVICE_DIR / "manifest.yaml"
    assert manifest_path.exists(), f"Manifest missing for ollama"
