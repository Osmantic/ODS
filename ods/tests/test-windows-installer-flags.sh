...
check '.\ods\installers\windows\install-windows.ps1 -InstallDir $_installDirHint' "$ROOT_DIR/installers/windows/phases/01-preflight.ps1" "Windows initial disk gate prints install-dir rerun hint"
check '.\ods\installers\windows\install-windows.ps1 -InstallDir $_installDirHint' "$ROOT_DIR/installers/windows/phases/02-detection.ps1" "Windows tier disk gate prints install-dir rerun hint"
check '.\ods\installers\windows\install-windows.ps1 -InstallDir $_installDirHint' "$ROOT_DIR/installers/windows/phases/04-requirements.ps1" "Windows requirements disk gate prints install-dir rerun hint"
