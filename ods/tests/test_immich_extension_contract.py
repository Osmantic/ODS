...
SERVICE_DIR = ROOT / "extensions/library/services/immich"

def test_immich_manifest_structure():
    manifest_path = SERVICE_DIR / "manifest.yaml"
    assert manifest_path.exists(), f"Manifest missing for immich"
