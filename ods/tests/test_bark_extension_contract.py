...
SERVICE_DIR = ROOT / "extensions/library/services/bark"

def test_bark_manifest_structure():
    manifest_path = SERVICE_DIR / "manifest.yaml"
    assert manifest_path.exists(), f"Manifest missing for bark"
