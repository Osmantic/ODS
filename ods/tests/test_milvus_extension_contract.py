...
SERVICE_DIR = ROOT / "extensions/library/services/milvus"

def test_milvus_manifest_structure():
    manifest_path = SERVICE_DIR / "manifest.yaml"
    assert manifest_path.exists(), f"Manifest missing for milvus"
