...
STUB
...

    {
        ...
        # Upstream gates rollback behind a native-identity preflight and parses
        # compose flags into an array; stub both so this exercises the restart
        # path rather than the refusal boundary in front of it.
        echo '_native_rollback_preflight(){ return 0; }'
        echo 'compose_flags_parse(){ COMPOSE_PARSED_ARGS=(); return 0; }'
        echo 'COMPOSE_PARSED_ARGS=()'
