...
assert_not_contains "$phase06_win" 'LemonadeCompact' "Windows installer must not inject the reduced LemonadeCompact tool profile"
assert_contains "$phase06_win" 'Remove-ODSManagedHermesReductions' "Windows installer must migrate exact legacy reductions without reintroducing them"
