...
SERVICE_DIR = ROOT / "extensions/library/services/dify"

def test_dify_manifest_structure():
    manifest_path = SERVICE_DIR / "manifest.yaml"
    assert manifest_path.exists(), f"Manifest missing for dify"
